...
import type { AcademicTerm, AcademicYear, BackupActivity, Lecture, LectureAttachment, LectureSummary, ReviewCard, ReviewList, ReviewSession, StudyStore, StudyTask, Subject, SubjectSection, TermKind, WeeklyReflection } from "@/lib/study-types";
...
const emptyStore: StudyStore = {
  ...
  syncSettings: { cloudBackupEnabled: false, recordingPartMinutes: 20, preferredPlaybackRate: 1, storageWarningPercent: 80, weeklyDigestEnabled: false, weeklyReflectionReminderEnabled: false, weeklyReflectionReminderHour: 20, weeklyReflectionReminderMinute: 0, weeklyReflectionFollowUpReminderEnabled: false, weeklyReflectionFollowUpDueReminderEnabled: false, weeklyReflectionFollowUpMonthlyGoal: 4, weeklyReflectionFollowUpStreakReminderEnabled: false, weeklyLectureGoal: 3, weeklyReviewGoal: 10, weeklyGoalNotificationEnabled: false, dailyFocusGoalMinutes: 30, dailyFocusReminderEnabled: false, weeklyReviewDays: [0, 2, 4], weeklyReviewReminderEnabled: false, weeklyReviewReminderHour: 18, weeklyReviewReminderMinute: 0, appearanceMode: "light", lastBackupStatus: "idle" },
};
...
function normalizeStore(value: Partial<StudyStore>): StudyStore {
  return {
    ...
    syncSettings: { cloudBackupEnabled: false, recordingPartMinutes: 20, preferredPlaybackRate: 1, storageWarningPercent: 80, weeklyDigestEnabled: false, weeklyReflectionFollowUpMonthlyGoal: 4, weeklyReflectionFollowUpStreakReminderEnabled: false, weeklyLectureGoal: 3, weeklyReviewGoal: 10, weeklyGoalNotificationEnabled: false, dailyFocusGoalMinutes: 30, dailyFocusReminderEnabled: false, weeklyReviewDays: [0, 2, 4], weeklyReviewReminderEnabled: false, weeklyReviewReminderHour: 18, weeklyReviewReminderMinute: 0, appearanceMode: "light", lastBackupStatus: "idle", ...value.syncSettings },
  };
}
