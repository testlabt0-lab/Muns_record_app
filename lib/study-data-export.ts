...
export function createStudyDataExport(store: StudyStore, exportedAt = new Date().toISOString()) {
  const { weeklyDigestNotificationId, dailyFocusReminderNotificationId, weeklyReflectionReminderNotificationId, weeklyReflectionFollowUpReminderNotificationId, weeklyReflectionFollowUpDueReminderNotificationId, weeklyReflectionFollowUpStreakReminderNotifiedForWeek, ...settings } = store.syncSettings;
  return {
