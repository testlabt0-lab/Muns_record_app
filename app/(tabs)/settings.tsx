...
export default function SettingsScreen() {
  ...
  const { years, terms, subjects, lectures, reviewCards, reviewLists, reviewSessions, reviewChallenges, tasks, syncSettings, updateSyncSettings, replaceStoreFromBackup, replaceStoreFromLocalImport, restoreReplacementSnapshot, deleteReplacementSnapshot, updateLecture, addAttachment, backupActivities, replacementSnapshots, addBackupActivity } = useStudy();
