...
export default function SettingsScreen() {
  ...
  const { years, terms, subjects, lectures, reviewCards, reviewLists, reviewSessions, reviewChallenges, tasks, syncSettings, updateSyncSettings, replaceStoreFromBackup, updateLecture, addAttachment, backupActivities, addBackupActivity } = useStudy();
