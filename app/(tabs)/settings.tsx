...
function StudyDataImportPicker({ visible, fileName, payload, selected, busy, onClose, onToggle, onApply }: { visible: boolean; fileName: string; payload: StudyDataImportPayload | null; selected: StudyDataImportSection[]; busy: boolean; onClose: () => void; onToggle: (section: StudyDataImportSection) => void; onApply: () => void }) {
