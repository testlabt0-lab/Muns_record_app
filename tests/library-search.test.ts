...
const lecture = {
  ...
  notes: [{ id: "note-1", text: "راجع الرسم قبل الاختبار العملي", timestampSeconds: 40, createdAt: "2026-08-20T00:00:00.000Z", updatedAt: "2026-08-20T00:00:00.000Z" }],
...
describe("فهرس المكتبة", () => {
  it("يضم النص والنقاط المستخرجة من مرفقات المحاضرة", () => {
    ...
    expect(index).toContain("راجع الرسم قبل الاختبار العملي");
  });
});
