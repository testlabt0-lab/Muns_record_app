...
describe("تقرير أرشيف الملاحظات", () => { it("ينشئ تقريراً عربياً وينظف نص الملاحظة", () => { const html = createWeeklyReflectionArchiveReportHtml([{ weekStart: "2026-01-05", note: "<خطة> الإحصاء", updatedAt: "x" }], new Date("2026-01-10T10:00:00Z")); expect(html).toContain("أرشيف الملاحظات الأسبوعية"); expect(html).toContain("&lt;خطة&gt; الإحصاء"); expect(html).toContain("1 ملاحظة مكتوبة"); }); });
